...
public class Elevator1  {
	...
	public Elevator1(Integer elevatorId, Integer hotelId, Integer currentFloor) {
	...
	public Elevator1(Integer elevatorId, Integer hotelId, Integer currentFloor, Integer numberOfFloors) {
		this.elevatorId = elevatorId;
		this.hotelId = hotelId;
		this.currentFloor = currentFloor;
	...
	public Elevator1 updateCurrentFloor(Integer currentFloor) {
		this.currentFloor = currentFloor;
		return this;
	}
